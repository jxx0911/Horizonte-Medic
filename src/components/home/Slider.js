    ...
    return (
        <ContenedorPrincipal>
            <ContenedorSlideshow ref={slideshow}>
                <Slide>
					<img className="slider__img" src={img1} alt="" style={{objectFit: "cover"}}/>
				</Slide>
				<Slide>
					<img className="slider__img" src={img2} alt="" style={{objecFit: "cover"}}/>
				</Slide>
				<Slide>
					<img className="slider__img" src={img3} alt="" style={{objecFit: "cover"}}/>
				</Slide>
				<Slide>
					<img className="slider__img" src={img4} alt="" style={{objecFit: "cover"}}/>
				</Slide>
            </ContenedorSlideshow>
